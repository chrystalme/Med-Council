"""Test-result attachments (Phase 3.5) — PDF / text upload attached to a case.

Each attachment links to a case and optionally to a follow-up question
index. Storage is delegated to `attachments.get_attachment_store()`
(local filesystem in dev, GCS in prod).
"""
